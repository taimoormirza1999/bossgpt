    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={`fixed bottom-4 lg:left-4 w-[80%] lg:w-[350px] bg-white/[22%] border-[0.7px] border-white/[42%] z-20  backdrop-blur-sm rounded-[0.4rem] shadow-lg overflow-hidden font-normal ${inter.className}`}
        >
          <div className="p-2 lg:p-3 pr-2 lg:pr-5">
            ...
            <div className="flex gap-2 lg:gap-3 items-center">
              <div className="lg:size-12 size-10 rounded-full bg-mbg-primary flex items-center justify-center flex-shrink-0">
