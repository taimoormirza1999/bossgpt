...
const Banner = () => {
  return (
    <motion.div
      className={`-z-10 relative lg:w-full h-auto min-h-[90vh] lg:min-h-[100vh] lg:-mt-[0vh] flex items-center  justify-between md:mt-20 mx-auto  mb-7 md:mb-10 lg:mb-20 xl:mb-0 pt-20 lg:pb-16 font-normal ${inter.className}`}
      style={{
        ...
        <div className=" mx-auto w-90 lg:w-full page-max-width grid grid-cols-1 lg:grid-cols-1 gap-12 items-center py-0 ">
          <div className="w-full">
            <motion.div
              ...
              className="space-y-6 text-center lg:text-start mb-[40%] lg:mb-[2%] "
            >
              {/* Title */}
              <motion.h1
                ...
                className="text-[3.5rem] md:text-4xl lg:text-[3.4rem] uppercase text-center leading-[3.7rem]  lg:leading-[3.7rem] lg:leading-auto lg:text-7xl 2xl:text-8xl font-primary font-black text-white/90"
              >
                Meet Your
                <br /> AI Boss
              </motion.h1>
