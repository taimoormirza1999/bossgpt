...
const CustomerReviews = () => {
  ...
  return (
    <section className="w-full py-16 bg-gradient-to-b from-mbg-translucent to-transparent to-20% text-white overflow-hidden" id="customers">
        ...
        <div ref={containerRef} className="w-full overflow-hidden">
          ...
          >
            ...
            {reviews.map((review, index) => (
              <motion.div
                key={index}
                className="flex-shrink-0 w-[350px]  rounded-[24px] bg-white/10  border-[1.6px] border-white/50 hover:border-[#3A3A3A] transition-all duration-300"
              >
              ...
              <Image
                ...
                <div className="flex flex-col  gap-2  mx-2 mt-3">
                  ...
                  <h3 className="text-[18px] font-extrabold font-primary  text-white">{review.name}</h3>
                  <p className="text-[14px] text-[#A1A1A1] leading-[1.6] font-primary  ">{review.review}</p>
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
